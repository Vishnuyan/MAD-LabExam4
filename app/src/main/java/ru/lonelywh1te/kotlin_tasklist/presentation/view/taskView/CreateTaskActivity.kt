...
class CreateTaskActivity : AppCompatActivity() {
    ...
    private fun createTask() {
        ...
        task = task.copy(title = title, description = description, completionDateInMillis = completionDateInMillis, taskGroupId = taskGroupId)
    }
    ...
    private fun setTaskCompletionDate() {
        ...
        if (completionDate != null) {
            datePickerDialog.setButton(DialogInterface.BUTTON_NEUTRAL, "Submit") { _, _ ->
                completionDate = null
                binding.btnSetTaskCompletionDate.text = "Submit"
            }
        }
